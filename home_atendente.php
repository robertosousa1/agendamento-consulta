    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">
				<div class="pull-left">
				<p>Atendente(a) <i><?php echo $_SESSION['nome']; ?></i>!</p>
				</div>
            </a>
        </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form">
                            <form method="POST" action="./dao/proc_edit_evento.php">
							...
							<div class="form-group">
                                <div class="form-group col-md-12">
									...
									<select name="nome_paciente" class="form-control" id="nome_paciente">
										<option>Selecione</option>
										<?php
										$result_paciente = "SELECT * FROM paciente";
										$resultado_paciente = mysqli_query($connection, $result_paciente);
										while ($row_paciente = mysqli_fetch_assoc($resultado_paciente)){ ?>
											<option value="<?php echo $row_paciente['id']; ?>"><?php echo $row_paciente['name']; ?>
											</option> <?php
										}
										?>
									</select>
        ...
        <div class="modal fade" id="cadastrar" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" method="POST" action="./dao/proc_cad_evento.php">
							<div class="form-group">
                                <div class="form-group col-md-12">
                                    <label>Consulta</label>
